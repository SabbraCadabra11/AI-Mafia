...
public enum Role {
    MAFIA("Mafia",
            "Your goal is to eliminate all Town members. At night, you coordinate with other Mafia to kill one player.",
            true),
    SHERIFF("Sheriff",
            "You are a Town investigator. Each night, you can investigate one player to learn if they are Mafia or Town.",
            false),
    DOCTOR("Doctor", "You are a Town protector. Each night, you can protect one player from being killed.", false),
    VILLAGER("Villager", "You are a regular Town member. Use logic and discussion to identify and eliminate the Mafia.",
            false);
